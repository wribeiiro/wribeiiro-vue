...
export default {
  state: {
    ...
    aboutMe: `Hi Devs 🖖! I'm Wellisson Ribeiro. I'm ${calculateMyYear()} years old, married, and father of two little girls.<br>Graduated in Analysis and Systems Development at UNOPAR.<br>Developer with some years of experience developing applications with different technologies,<br>but with a focus on PHP (Code Igniter v3/v4, Laravel, Lumen Frameworks)</.>.<br>I am currently work a software engineer at <a class='soft' href='https://www.softexpert.com/'>SoftExpert.</a><br>All packages are up to date.</span><br>`,
    aboutComplete: ``
  },
  getters: {
    getAboutMe(state) {
